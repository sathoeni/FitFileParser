...
public func rzfit_swift_reverse_value(mesg: String, field: String, value: String) -> RzFitSwiftValue {
  ...
  case "training_settings": // 13
    return rzfit_swift_reverse_value_training_settings(field: field, value: value )
  case "goal": // 15
...
fileprivate func rzfit_swift_reverse_value_training_settings(field: String, value: String) -> RzFitSwiftValue {
  switch field {
    case "target_distance": // uint32
      guard let dbl : Double = Double(value) else { return .unknown }
      return .value(dbl)
    case "target_speed": // uint16
      guard let dbl : Double = Double(value) else { return .unknown }
      return .value(dbl)
    case "target_time": // uint32
      guard let dbl : Double = Double(value) else { return .unknown }
      return .value(dbl)
    case "precise_target_speed": // uint32
      guard let dbl : Double = Double(value) else { return .unknown }
      return .value(dbl)
  default:
    return .unknown
...
fileprivate func rzfit_swift_reverse_value_mesg_num(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "13": return .string("training_settings")
    case "training_settings": return .string("13")
...
fileprivate func rzfit_swift_reverse_value_manufacturer(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "153": return .string("luhong_technology")
    case "luhong_technology": return .string("153")
    ...
    case "333": return .string("tektro_racing_products")
    case "tektro_racing_products": return .string("333")
    case "334": return .string("darad_innovation_corporation")
    case "darad_innovation_corporation": return .string("334")
    case "335": return .string("cycloptim")
    case "cycloptim": return .string("335")
...
fileprivate func rzfit_swift_reverse_value_garmin_product(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "3076": return .string("fr245")
    case "fr245": return .string("3076")
    case "3077": return .string("fr245_music")
    case "fr245_music": return .string("3077")
    ...
    case "3282": return .string("fr45")
    case "fr45": return .string("3282")
    ...
    case "3596": return .string("venusq_music")
    case "venusq_music": return .string("3596")
    case "3599": return .string("venusq_music_v2")
    case "venusq_music_v2": return .string("3599")
    ...
    case "3889": return .string("instinct_2s")
    case "instinct_2s": return .string("3889")
    ...
    case "4583": return .string("instinctE_40mm")
    case "instinctE_40mm": return .string("4583")
    case "4584": return .string("instinctE_45mm")
    case "instinctE_45mm": return .string("4584")
    case "4585": return .string("instinct3_solar_45mm")
    case "instinct3_solar_45mm": return .string("4585")
    case "4586": return .string("instinct3_amoled_45mm")
    case "instinct3_amoled_45mm": return .string("4586")
    case "4587": return .string("instinct3_amoled_50mm")
    case "instinct3_amoled_50mm": return .string("4587")
    case "4588": return .string("descent_g2")
    case "descent_g2": return .string("4588")
    case "4606": return .string("hrm_200")
    case "hrm_200": return .string("4606")
    case "4625": return .string("vivoactive6")
    case "vivoactive6": return .string("4625")
    case "4647": return .string("approachS44")
    case "approachS44": return .string("4647")
    case "4656": return .string("approachS50")
    case "approachS50": return .string("4656")
    case "4666": return .string("fenix_e")
    case "fenix_e": return .string("4666")
    case "4759": return .string("instinct3_solar_50mm")
    case "instinct3_solar_50mm": return .string("4759")
    case "4775": return .string("tactix8_amoled")
    case "tactix8_amoled": return .string("4775")
    case "4776": return .string("tactix8_solar")
    case "tactix8_solar": return .string("4776")
...
fileprivate func rzfit_swift_reverse_value_swim_stroke(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "7": return .string("im_by_round")
    case "im_by_round": return .string("7")
    case "8": return .string("rimo")
    case "rimo": return .string("8")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_exercise_category(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "33": return .string("bike")
    case "bike": return .string("33")
    case "34": return .string("cardio_sensors")
    case "cardio_sensors": return .string("34")
    case "35": return .string("move")
    case "move": return .string("35")
    case "36": return .string("pose")
    case "pose": return .string("36")
    case "37": return .string("banded_exercises")
    case "banded_exercises": return .string("37")
    case "38": return .string("battle_rope")
    case "battle_rope": return .string("38")
    case "39": return .string("elliptical")
    case "elliptical": return .string("39")
    case "40": return .string("floor_climb")
    case "floor_climb": return .string("40")
    case "41": return .string("indoor_bike")
    case "indoor_bike": return .string("41")
    case "42": return .string("indoor_row")
    case "indoor_row": return .string("42")
    case "43": return .string("ladder")
    case "ladder": return .string("43")
    case "44": return .string("sandbag")
    case "sandbag": return .string("44")
    case "45": return .string("sled")
    case "sled": return .string("45")
    case "46": return .string("sledge_hammer")
    case "sledge_hammer": return .string("46")
    case "47": return .string("stair_stepper")
    case "stair_stepper": return .string("47")
    case "49": return .string("suspension")
    case "suspension": return .string("49")
    case "50": return .string("tire")
    case "tire": return .string("50")
    case "52": return .string("run_indoor")
    case "run_indoor": return .string("52")
    case "53": return .string("bike_outdoor")
    case "bike_outdoor": return .string("53")
...
fileprivate func rzfit_swift_reverse_value_cardio_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "22": return .string("elliptical")
    case "elliptical": return .string("22")
    case "23": return .string("spinning")
    case "spinning": return .string("23")
    case "24": return .string("pole_paddle_forward_wheelchair")
    case "pole_paddle_forward_wheelchair": return .string("24")
    case "25": return .string("pole_paddle_backward_wheelchair")
    case "pole_paddle_backward_wheelchair": return .string("25")
    case "26": return .string("pole_handcycle_forward_wheelchair")
    case "pole_handcycle_forward_wheelchair": return .string("26")
    case "27": return .string("pole_handcycle_backward_wheelchair")
    case "pole_handcycle_backward_wheelchair": return .string("27")
    case "28": return .string("pole_rainbow_wheelchair")
    case "pole_rainbow_wheelchair": return .string("28")
    case "29": return .string("double_punch_forward_wheelchair")
    case "double_punch_forward_wheelchair": return .string("29")
    case "30": return .string("double_punch_down_wheelchair")
    case "double_punch_down_wheelchair": return .string("30")
    case "31": return .string("double_punch_sideways_wheelchair")
    case "double_punch_sideways_wheelchair": return .string("31")
    case "32": return .string("double_punch_up_wheelchair")
    case "double_punch_up_wheelchair": return .string("32")
    case "33": return .string("sit_ski_wheelchair")
    case "sit_ski_wheelchair": return .string("33")
    case "34": return .string("sitting_jacks_wheelchair")
    case "sitting_jacks_wheelchair": return .string("34")
    case "35": return .string("punch_forward_wheelchair")
    case "punch_forward_wheelchair": return .string("35")
    case "36": return .string("punch_down_wheelchair")
    case "punch_down_wheelchair": return .string("36")
    case "37": return .string("punch_sideways_wheelchair")
    case "punch_sideways_wheelchair": return .string("37")
    case "38": return .string("punch_up_wheelchair")
    case "punch_up_wheelchair": return .string("38")
    case "39": return .string("punch_bag_wheelchair")
    case "punch_bag_wheelchair": return .string("39")
    case "40": return .string("pole_dd_ff_uu_wheelchair")
    case "pole_dd_ff_uu_wheelchair": return .string("40")
    case "41": return .string("butterfly_arms_wheelchair")
    case "butterfly_arms_wheelchair": return .string("41")
    case "42": return .string("punch")
    case "punch": return .string("42")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_carry_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "5": return .string("dumbbell_waiter_carry")
    case "dumbbell_waiter_carry": return .string("5")
    case "6": return .string("farmers_carry_walk_lunge")
    case "farmers_carry_walk_lunge": return .string("6")
    case "7": return .string("farmers_carry")
    case "farmers_carry": return .string("7")
    case "8": return .string("farmers_carry_on_toes")
    case "farmers_carry_on_toes": return .string("8")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_core_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "73": return .string("bicep_curl_with_leg_extension_with_weights")
    case "bicep_curl_with_leg_extension_with_weights": return .string("73")
    case "75": return .string("hanging_l_sit")
    case "hanging_l_sit": return .string("75")
    case "77": return .string("lower_lift_with_weights")
    case "lower_lift_with_weights": return .string("77")
    case "79": return .string("ring_l_sit")
    case "ring_l_sit": return .string("79")
    case "80": return .string("rowing_1_with_weights")
    case "rowing_1_with_weights": return .string("80")
    case "81": return .string("rowing_2_with_weights")
    case "rowing_2_with_weights": return .string("81")
    case "82": return .string("scissors_with_weights")
    case "scissors_with_weights": return .string("82")
    case "83": return .string("single_leg_stretch_with_weights")
    case "single_leg_stretch_with_weights": return .string("83")
    case "84": return .string("toes_to_elbows")
    case "toes_to_elbows": return .string("84")
    case "85": return .string("weighted_criss_cross")
    case "weighted_criss_cross": return .string("85")
    case "86": return .string("weighted_double_leg_stretch")
    case "weighted_double_leg_stretch": return .string("86")
    case "87": return .string("weighted_the_hundred")
    case "weighted_the_hundred": return .string("87")
    case "88": return .string("l_sit")
    case "l_sit": return .string("88")
    case "89": return .string("turkish_get_up")
    case "turkish_get_up": return .string("89")
    case "90": return .string("weighted_ring_l_sit")
    case "weighted_ring_l_sit": return .string("90")
    case "91": return .string("weighted_hanging_l_sit")
    case "weighted_hanging_l_sit": return .string("91")
    case "92": return .string("weighted_l_sit")
    case "weighted_l_sit": return .string("92")
    case "93": return .string("side_bend_low_wheelchair")
    case "side_bend_low_wheelchair": return .string("93")
    case "94": return .string("side_bend_mid_wheelchair")
    case "side_bend_mid_wheelchair": return .string("94")
    case "95": return .string("side_bend_high_wheelchair")
    case "side_bend_high_wheelchair": return .string("95")
    case "96": return .string("seated_side_bend")
    case "seated_side_bend": return .string("96")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_crunch_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "86": return .string("leg_climb_crunch")
    case "leg_climb_crunch": return .string("86")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_curl_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "44": return .string("one_arm_concentration_curl")
    case "one_arm_concentration_curl": return .string("44")
    case "45": return .string("standing_zottman_biceps_curl")
    case "standing_zottman_biceps_curl": return .string("45")
    case "46": return .string("dumbbell_biceps_curl")
    case "dumbbell_biceps_curl": return .string("46")
    case "47": return .string("drag_curl_wheelchair")
    case "drag_curl_wheelchair": return .string("47")
    case "48": return .string("dumbbell_biceps_curl_wheelchair")
    case "dumbbell_biceps_curl_wheelchair": return .string("48")
    case "49": return .string("bottle_curl")
    case "bottle_curl": return .string("49")
    case "50": return .string("seated_bottle_curl")
    case "seated_bottle_curl": return .string("50")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_deadlift_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "20": return .string("kettlebell_deadlift")
    case "kettlebell_deadlift": return .string("20")
    case "21": return .string("kettlebell_sumo_deadlift")
    case "kettlebell_sumo_deadlift": return .string("21")
    case "23": return .string("romanian_deadlift")
    case "romanian_deadlift": return .string("23")
    case "24": return .string("single_leg_romanian_deadlift_circuit")
    case "single_leg_romanian_deadlift_circuit": return .string("24")
    case "25": return .string("straight_leg_deadlift")
    case "straight_leg_deadlift": return .string("25")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_flye_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "10": return .string("face_down_incline_reverse_flye")
    case "face_down_incline_reverse_flye": return .string("10")
    case "11": return .string("incline_reverse_flye")
    case "incline_reverse_flye": return .string("11")
    case "12": return .string("rear_delt_fly_wheelchair")
    case "rear_delt_fly_wheelchair": return .string("12")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_hip_stability_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "34": return .string("lying_abduction_stretch")
    case "lying_abduction_stretch": return .string("34")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_hip_swing_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "3": return .string("one_arm_swing")
    case "one_arm_swing": return .string("3")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_lateral_raise_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "34": return .string("dumbbell_lateral_raise")
    case "dumbbell_lateral_raise": return .string("34")
    case "36": return .string("ring_dip_kipping")
    case "ring_dip_kipping": return .string("36")
    case "37": return .string("wall_walk")
    case "wall_walk": return .string("37")
    case "38": return .string("dumbbell_front_raise_wheelchair")
    case "dumbbell_front_raise_wheelchair": return .string("38")
    case "39": return .string("dumbbell_lateral_raise_wheelchair")
    case "dumbbell_lateral_raise_wheelchair": return .string("39")
    case "40": return .string("pole_double_arm_overhead_and_forward_wheelchair")
    case "pole_double_arm_overhead_and_forward_wheelchair": return .string("40")
    case "41": return .string("pole_straight_arm_overhead_wheelchair")
    case "pole_straight_arm_overhead_wheelchair": return .string("41")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_leg_curl_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "12": return .string("band_good_morning")
    case "band_good_morning": return .string("12")
    case "13": return .string("bar_good_morning")
    case "bar_good_morning": return .string("13")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_lunge_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "81": return .string("alternating_dumbbell_lunge")
    case "alternating_dumbbell_lunge": return .string("81")
    case "82": return .string("dumbbell_reverse_lunge")
    case "dumbbell_reverse_lunge": return .string("82")
    case "83": return .string("overhead_dumbbell_lunge")
    case "overhead_dumbbell_lunge": return .string("83")
    case "84": return .string("scissor_power_switch")
    case "scissor_power_switch": return .string("84")
    case "85": return .string("dumbbell_overhead_walking_lunge")
    case "dumbbell_overhead_walking_lunge": return .string("85")
    case "86": return .string("curtsy_lunge")
    case "curtsy_lunge": return .string("86")
    case "87": return .string("weighted_curtsy_lunge")
    case "weighted_curtsy_lunge": return .string("87")
    case "88": return .string("weighted_shifting_side_lunge")
    case "weighted_shifting_side_lunge": return .string("88")
    case "89": return .string("weighted_side_lunge_and_press")
    case "weighted_side_lunge_and_press": return .string("89")
    case "90": return .string("weighted_side_lunge_jump_off")
    case "weighted_side_lunge_jump_off": return .string("90")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_olympic_lift_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "21": return .string("dumbbell_hang_snatch")
    case "dumbbell_hang_snatch": return .string("21")
    case "22": return .string("dumbbell_power_clean_and_jerk")
    case "dumbbell_power_clean_and_jerk": return .string("22")
    case "23": return .string("dumbbell_power_clean_and_push_press")
    case "dumbbell_power_clean_and_push_press": return .string("23")
    case "24": return .string("dumbbell_power_clean_and_strict_press")
    case "dumbbell_power_clean_and_strict_press": return .string("24")
    case "25": return .string("dumbbell_snatch")
    case "dumbbell_snatch": return .string("25")
    case "26": return .string("medicine_ball_clean")
    case "medicine_ball_clean": return .string("26")
    case "27": return .string("clean_and_press")
    case "clean_and_press": return .string("27")
    case "28": return .string("snatch")
    case "snatch": return .string("28")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_plank_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "135": return .string("ring_plank_sprawls")
    case "ring_plank_sprawls": return .string("135")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_plyo_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "33": return .string("box_jump")
    case "box_jump": return .string("33")
    case "34": return .string("box_jump_overs")
    case "box_jump_overs": return .string("34")
    case "35": return .string("box_jump_overs_over_the_box")
    case "box_jump_overs_over_the_box": return .string("35")
    case "36": return .string("star_jump_squats")
    case "star_jump_squats": return .string("36")
    case "37": return .string("jump_squat")
    case "jump_squat": return .string("37")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_pull_up_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "39": return .string("chin_up")
    case "chin_up": return .string("39")
    case "40": return .string("neutral_grip_chin_up")
    case "neutral_grip_chin_up": return .string("40")
    case "41": return .string("weighted_chin_up")
    case "weighted_chin_up": return .string("41")
    case "42": return .string("band_assisted_pull_up")
    case "band_assisted_pull_up": return .string("42")
    case "43": return .string("neutral_grip_pull_up")
    case "neutral_grip_pull_up": return .string("43")
    case "44": return .string("weighted_neutral_grip_chin_up")
    case "weighted_neutral_grip_chin_up": return .string("44")
    case "45": return .string("weighted_neutral_grip_pull_up")
    case "weighted_neutral_grip_pull_up": return .string("45")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_push_up_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "79": return .string("dynamic_push_up")
    case "dynamic_push_up": return .string("79")
    case "80": return .string("kipping_handstand_push_up")
    case "kipping_handstand_push_up": return .string("80")
    case "81": return .string("shoulder_tapping_push_up")
    case "shoulder_tapping_push_up": return .string("81")
    case "82": return .string("biceps_push_up")
    case "biceps_push_up": return .string("82")
    case "83": return .string("hindu_push_up")
    case "hindu_push_up": return .string("83")
    case "84": return .string("pike_push_up")
    case "pike_push_up": return .string("84")
    case "85": return .string("wide_grip_push_up")
    case "wide_grip_push_up": return .string("85")
    case "86": return .string("weighted_biceps_push_up")
    case "weighted_biceps_push_up": return .string("86")
    case "87": return .string("weighted_hindu_push_up")
    case "weighted_hindu_push_up": return .string("87")
    case "88": return .string("weighted_pike_push_up")
    case "weighted_pike_push_up": return .string("88")
    case "89": return .string("kipping_parallette_handstand_push_up")
    case "kipping_parallette_handstand_push_up": return .string("89")
    case "90": return .string("wall_push_up")
    case "wall_push_up": return .string("90")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_row_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "34": return .string("alternating_dumbbell_row")
    case "alternating_dumbbell_row": return .string("34")
    case "35": return .string("inverted_row")
    case "inverted_row": return .string("35")
    case "36": return .string("row")
    case "row": return .string("36")
    case "37": return .string("weighted_row")
    case "weighted_row": return .string("37")
    case "38": return .string("indoor_row")
    case "indoor_row": return .string("38")
    case "39": return .string("banded_face_pulls")
    case "banded_face_pulls": return .string("39")
    case "40": return .string("chest_supported_dumbbell_row")
    case "chest_supported_dumbbell_row": return .string("40")
    case "41": return .string("decline_ring_row")
    case "decline_ring_row": return .string("41")
    case "42": return .string("elevated_ring_row")
    case "elevated_ring_row": return .string("42")
    case "43": return .string("rdl_bent_over_row_with_barbell_dumbbell")
    case "rdl_bent_over_row_with_barbell_dumbbell": return .string("43")
    case "44": return .string("ring_row")
    case "ring_row": return .string("44")
    case "45": return .string("barbell_row")
    case "barbell_row": return .string("45")
    case "46": return .string("bent_over_row_with_barbell")
    case "bent_over_row_with_barbell": return .string("46")
    case "47": return .string("bent_over_row_with_dumbell")
    case "bent_over_row_with_dumbell": return .string("47")
    case "48": return .string("seated_underhand_grip_cable_row")
    case "seated_underhand_grip_cable_row": return .string("48")
    case "49": return .string("trx_inverted_row")
    case "trx_inverted_row": return .string("49")
    case "50": return .string("weighted_inverted_row")
    case "weighted_inverted_row": return .string("50")
    case "51": return .string("weighted_trx_inverted_row")
    case "weighted_trx_inverted_row": return .string("51")
    case "52": return .string("dumbbell_row_wheelchair")
    case "dumbbell_row_wheelchair": return .string("52")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_shoulder_press_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "24": return .string("dumbbell_shoulder_press")
    case "dumbbell_shoulder_press": return .string("24")
    case "25": return .string("military_press")
    case "military_press": return .string("25")
    case "27": return .string("strict_press")
    case "strict_press": return .string("27")
    case "28": return .string("dumbbell_front_raise")
    case "dumbbell_front_raise": return .string("28")
    case "29": return .string("dumbbell_curl_to_overhead_press_wheelchair")
    case "dumbbell_curl_to_overhead_press_wheelchair": return .string("29")
    case "30": return .string("arnold_press_wheelchair")
    case "arnold_press_wheelchair": return .string("30")
    case "31": return .string("overhead_dumbbell_press_wheelchair")
    case "overhead_dumbbell_press_wheelchair": return .string("31")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_shoulder_stability_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "33": return .string("cable_internal_rotation")
    case "cable_internal_rotation": return .string("33")
    case "34": return .string("lying_internal_rotation")
    case "lying_internal_rotation": return .string("34")
    case "35": return .string("seated_dumbbell_internal_rotation")
    case "seated_dumbbell_internal_rotation": return .string("35")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_shrug_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "17": return .string("wide_grip_barbell_shrug")
    case "wide_grip_barbell_shrug": return .string("17")
    case "18": return .string("behind_the_back_shrug")
    case "behind_the_back_shrug": return .string("18")
    case "19": return .string("dumbbell_shrug_wheelchair")
    case "dumbbell_shrug_wheelchair": return .string("19")
    case "20": return .string("shrug_wheelchair")
    case "shrug_wheelchair": return .string("20")
    case "21": return .string("shrug_arm_down_wheelchair")
    case "shrug_arm_down_wheelchair": return .string("21")
    case "22": return .string("shrug_arm_mid_wheelchair")
    case "shrug_arm_mid_wheelchair": return .string("22")
    case "23": return .string("shrug_arm_up_wheelchair")
    case "shrug_arm_up_wheelchair": return .string("23")
    case "24": return .string("upright_row")
    case "upright_row": return .string("24")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_sit_up_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "38": return .string("ghd_sit_ups")
    case "ghd_sit_ups": return .string("38")
    case "39": return .string("sit_up_turkish_get_up")
    case "sit_up_turkish_get_up": return .string("39")
    case "40": return .string("russian_twist_on_swiss_ball")
    case "russian_twist_on_swiss_ball": return .string("40")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_squat_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "92": return .string("alternating_box_dumbbell_step_ups")
    case "alternating_box_dumbbell_step_ups": return .string("92")
    case "93": return .string("dumbbell_overhead_squat_single_arm")
    case "dumbbell_overhead_squat_single_arm": return .string("93")
    case "94": return .string("dumbbell_squat_snatch")
    case "dumbbell_squat_snatch": return .string("94")
    case "95": return .string("medicine_ball_squat")
    case "medicine_ball_squat": return .string("95")
    case "97": return .string("wall_ball_squat_and_press")
    case "wall_ball_squat_and_press": return .string("97")
    case "98": return .string("squat_american_swing")
    case "squat_american_swing": return .string("98")
    case "100": return .string("air_squat")
    case "air_squat": return .string("100")
    case "101": return .string("dumbbell_thrusters")
    case "dumbbell_thrusters": return .string("101")
    case "102": return .string("overhead_barbell_squat")
    case "overhead_barbell_squat": return .string("102")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_total_body_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "13": return .string("barbell_burpee")
    case "barbell_burpee": return .string("13")
    case "15": return .string("burpee_box_jump_over_yes_literally_jumping_over_the_box")
    case "burpee_box_jump_over_yes_literally_jumping_over_the_box": return .string("15")
    case "16": return .string("burpee_box_jump_step_up_over")
    case "burpee_box_jump_step_up_over": return .string("16")
    case "17": return .string("lateral_barbell_burpee")
    case "lateral_barbell_burpee": return .string("17")
    case "18": return .string("total_body_burpee_over_bar")
    case "total_body_burpee_over_bar": return .string("18")
    case "19": return .string("burpee_box_jump_over")
    case "burpee_box_jump_over": return .string("19")
    case "20": return .string("burpee_wheelchair")
    case "burpee_wheelchair": return .string("20")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_move_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("arch_and_curl")
    case "arch_and_curl": return .string("0")
    case "1": return .string("arm_circles_with_ball_band_and_weight")
    case "arm_circles_with_ball_band_and_weight": return .string("1")
    case "2": return .string("arm_stretch")
    case "arm_stretch": return .string("2")
    case "3": return .string("back_massage")
    case "back_massage": return .string("3")
    case "4": return .string("belly_breathing")
    case "belly_breathing": return .string("4")
    case "5": return .string("bridge_with_ball")
    case "bridge_with_ball": return .string("5")
    case "6": return .string("diamond_leg_crunch")
    case "diamond_leg_crunch": return .string("6")
    case "7": return .string("diamond_leg_lift")
    case "diamond_leg_lift": return .string("7")
    case "8": return .string("eight_point_shoulder_opener")
    case "eight_point_shoulder_opener": return .string("8")
    case "9": return .string("foot_rolling")
    case "foot_rolling": return .string("9")
    case "10": return .string("footwork")
    case "footwork": return .string("10")
    case "11": return .string("footwork_on_disc")
    case "footwork_on_disc": return .string("11")
    case "12": return .string("forward_fold")
    case "forward_fold": return .string("12")
    case "13": return .string("frog_with_band")
    case "frog_with_band": return .string("13")
    case "14": return .string("half_roll_up")
    case "half_roll_up": return .string("14")
    case "15": return .string("hamstring_curl")
    case "hamstring_curl": return .string("15")
    case "16": return .string("hamstring_stretch")
    case "hamstring_stretch": return .string("16")
    case "17": return .string("hip_stretch")
    case "hip_stretch": return .string("17")
    case "18": return .string("hug_a_tree_with_ball_band_and_weight")
    case "hug_a_tree_with_ball_band_and_weight": return .string("18")
    case "19": return .string("knee_circles")
    case "knee_circles": return .string("19")
    case "20": return .string("knee_folds_on_disc")
    case "knee_folds_on_disc": return .string("20")
    case "21": return .string("lateral_flexion")
    case "lateral_flexion": return .string("21")
    case "22": return .string("leg_stretch_with_band")
    case "leg_stretch_with_band": return .string("22")
    case "23": return .string("leg_stretch_with_leg_circles")
    case "leg_stretch_with_leg_circles": return .string("23")
    case "24": return .string("lower_lift_on_disc")
    case "lower_lift_on_disc": return .string("24")
    case "25": return .string("lunge_squat")
    case "lunge_squat": return .string("25")
    case "26": return .string("lunges_with_knee_lift")
    case "lunges_with_knee_lift": return .string("26")
    case "27": return .string("mermaid_stretch")
    case "mermaid_stretch": return .string("27")
    case "28": return .string("neutral_pelvic_position")
    case "neutral_pelvic_position": return .string("28")
    case "29": return .string("pelvic_clocks_on_disc")
    case "pelvic_clocks_on_disc": return .string("29")
    case "30": return .string("pilates_plie_squats_parallel_turned_out_flat_and_heels_with_chair")
    case "pilates_plie_squats_parallel_turned_out_flat_and_heels_with_chair": return .string("30")
    case "31": return .string("piriformis_stretch")
    case "piriformis_stretch": return .string("31")
    case "32": return .string("plank_knee_crosses")
    case "plank_knee_crosses": return .string("32")
    case "33": return .string("plank_knee_pulls")
    case "plank_knee_pulls": return .string("33")
    case "34": return .string("plank_up_downs")
    case "plank_up_downs": return .string("34")
    case "35": return .string("prayer_mudra")
    case "prayer_mudra": return .string("35")
    case "36": return .string("psoas_lunge_stretch")
    case "psoas_lunge_stretch": return .string("36")
    case "37": return .string("ribcage_breathing")
    case "ribcage_breathing": return .string("37")
    case "38": return .string("roll_down")
    case "roll_down": return .string("38")
    case "39": return .string("roll_up_with_weight_and_band")
    case "roll_up_with_weight_and_band": return .string("39")
    case "40": return .string("saw")
    case "saw": return .string("40")
    case "41": return .string("scapular_stabilization")
    case "scapular_stabilization": return .string("41")
    case "42": return .string("scissors_on_disc")
    case "scissors_on_disc": return .string("42")
    case "43": return .string("seated_hip_stretchup")
    case "seated_hip_stretchup": return .string("43")
    case "44": return .string("seated_twist")
    case "seated_twist": return .string("44")
    case "45": return .string("shaving_the_head_with_ball_band_and_weight")
    case "shaving_the_head_with_ball_band_and_weight": return .string("45")
    case "46": return .string("spinal_twist")
    case "spinal_twist": return .string("46")
    case "47": return .string("spinal_twist_stretch")
    case "spinal_twist_stretch": return .string("47")
    case "48": return .string("spine_stretch_forward")
    case "spine_stretch_forward": return .string("48")
    case "49": return .string("squat_open_arm_twist_pose")
    case "squat_open_arm_twist_pose": return .string("49")
    case "50": return .string("squats_with_ball")
    case "squats_with_ball": return .string("50")
    case "51": return .string("stand_and_hang")
    case "stand_and_hang": return .string("51")
    case "52": return .string("standing_side_stretch")
    case "standing_side_stretch": return .string("52")
    case "53": return .string("standing_single_leg_forward_bend_with_it_band_opener")
    case "standing_single_leg_forward_bend_with_it_band_opener": return .string("53")
    case "54": return .string("straight_leg_crunch_with_leg_lift")
    case "straight_leg_crunch_with_leg_lift": return .string("54")
    case "55": return .string("straight_leg_crunch_with_leg_lift_with_ball")
    case "straight_leg_crunch_with_leg_lift_with_ball": return .string("55")
    case "56": return .string("straight_leg_crunch_with_legs_crossed")
    case "straight_leg_crunch_with_legs_crossed": return .string("56")
    case "57": return .string("straight_leg_crunch_with_legs_crossed_with_ball")
    case "straight_leg_crunch_with_legs_crossed_with_ball": return .string("57")
    case "58": return .string("straight_leg_diagonal_crunch")
    case "straight_leg_diagonal_crunch": return .string("58")
    case "59": return .string("straight_leg_diagonal_crunch_with_ball")
    case "straight_leg_diagonal_crunch_with_ball": return .string("59")
    case "60": return .string("tailbone_curl")
    case "tailbone_curl": return .string("60")
    case "61": return .string("throat_lock")
    case "throat_lock": return .string("61")
    case "62": return .string("tick_tock_side_roll")
    case "tick_tock_side_roll": return .string("62")
    case "63": return .string("twist")
    case "twist": return .string("63")
    case "64": return .string("v_leg_crunches")
    case "v_leg_crunches": return .string("64")
    case "65": return .string("v_sit")
    case "v_sit": return .string("65")
    case "66": return .string("forward_fold_wheelchair")
    case "forward_fold_wheelchair": return .string("66")
    case "67": return .string("forward_fold_plus_wheelchair")
    case "forward_fold_plus_wheelchair": return .string("67")
    case "68": return .string("arm_circles_low_forward_wheelchair")
    case "arm_circles_low_forward_wheelchair": return .string("68")
    case "69": return .string("arm_circles_mid_forward_wheelchair")
    case "arm_circles_mid_forward_wheelchair": return .string("69")
    case "70": return .string("arm_circles_high_forward_wheelchair")
    case "arm_circles_high_forward_wheelchair": return .string("70")
    case "71": return .string("arm_circles_low_backward_wheelchair")
    case "arm_circles_low_backward_wheelchair": return .string("71")
    case "72": return .string("arm_circles_mid_backward_wheelchair")
    case "arm_circles_mid_backward_wheelchair": return .string("72")
    case "73": return .string("arm_circles_high_backward_wheelchair")
    case "arm_circles_high_backward_wheelchair": return .string("73")
    case "74": return .string("core_twists_wheelchair")
    case "core_twists_wheelchair": return .string("74")
    case "75": return .string("arm_raise_wheelchair")
    case "arm_raise_wheelchair": return .string("75")
    case "76": return .string("chest_expand_wheelchair")
    case "chest_expand_wheelchair": return .string("76")
    case "77": return .string("arm_extend_wheelchair")
    case "arm_extend_wheelchair": return .string("77")
    case "78": return .string("forward_bend_wheelchair")
    case "forward_bend_wheelchair": return .string("78")
    case "79": return .string("toe_touch_wheelchair")
    case "toe_touch_wheelchair": return .string("79")
    case "80": return .string("extended_toe_touch_wheelchair")
    case "extended_toe_touch_wheelchair": return .string("80")
    case "81": return .string("seated_arm_circles")
    case "seated_arm_circles": return .string("81")
    case "82": return .string("trunk_rotations")
    case "trunk_rotations": return .string("82")
    case "83": return .string("seated_trunk_rotations")
    case "seated_trunk_rotations": return .string("83")
    case "84": return .string("toe_touch")
    case "toe_touch": return .string("84")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_pose_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("all_fours")
    case "all_fours": return .string("0")
    case "1": return .string("ankle_to_knee")
    case "ankle_to_knee": return .string("1")
    case "2": return .string("baby_cobra")
    case "baby_cobra": return .string("2")
    case "3": return .string("boat")
    case "boat": return .string("3")
    case "4": return .string("bound_angle")
    case "bound_angle": return .string("4")
    case "5": return .string("bound_seated_single_leg_forward_bend")
    case "bound_seated_single_leg_forward_bend": return .string("5")
    case "6": return .string("bow")
    case "bow": return .string("6")
    case "7": return .string("bowed_half_moon")
    case "bowed_half_moon": return .string("7")
    case "8": return .string("bridge")
    case "bridge": return .string("8")
    case "9": return .string("cat")
    case "cat": return .string("9")
    case "10": return .string("chair")
    case "chair": return .string("10")
    case "11": return .string("childs")
    case "childs": return .string("11")
    case "12": return .string("corpse")
    case "corpse": return .string("12")
    case "13": return .string("cow_face")
    case "cow_face": return .string("13")
    case "14": return .string("cow")
    case "cow": return .string("14")
    case "15": return .string("devotional_warrior")
    case "devotional_warrior": return .string("15")
    case "16": return .string("dolphin_plank")
    case "dolphin_plank": return .string("16")
    case "17": return .string("dolphin")
    case "dolphin": return .string("17")
    case "18": return .string("down_dog_knee_to_nose")
    case "down_dog_knee_to_nose": return .string("18")
    case "19": return .string("down_dog_split")
    case "down_dog_split": return .string("19")
    case "20": return .string("down_dog_split_open_hip_bent_knee")
    case "down_dog_split_open_hip_bent_knee": return .string("20")
    case "21": return .string("downward_facing_dog")
    case "downward_facing_dog": return .string("21")
    case "22": return .string("eagle")
    case "eagle": return .string("22")
    case "23": return .string("easy_seated")
    case "easy_seated": return .string("23")
    case "24": return .string("extended_puppy")
    case "extended_puppy": return .string("24")
    case "25": return .string("extended_side_angle")
    case "extended_side_angle": return .string("25")
    case "26": return .string("fish")
    case "fish": return .string("26")
    case "27": return .string("four_limbed_staff")
    case "four_limbed_staff": return .string("27")
    case "28": return .string("full_split")
    case "full_split": return .string("28")
    case "29": return .string("gate")
    case "gate": return .string("29")
    case "30": return .string("half_chair_half_ankle_to_knee")
    case "half_chair_half_ankle_to_knee": return .string("30")
    case "31": return .string("half_moon")
    case "half_moon": return .string("31")
    case "32": return .string("head_to_knee")
    case "head_to_knee": return .string("32")
    case "33": return .string("heron")
    case "heron": return .string("33")
    case "34": return .string("heros")
    case "heros": return .string("34")
    case "35": return .string("high_lunge")
    case "high_lunge": return .string("35")
    case "36": return .string("knees_chest_chin")
    case "knees_chest_chin": return .string("36")
    case "37": return .string("lizard")
    case "lizard": return .string("37")
    case "38": return .string("locust")
    case "locust": return .string("38")
    case "39": return .string("low_lunge")
    case "low_lunge": return .string("39")
    case "40": return .string("low_lunge_twist")
    case "low_lunge_twist": return .string("40")
    case "41": return .string("low_lunge_with_knee_down")
    case "low_lunge_with_knee_down": return .string("41")
    case "42": return .string("mermaid")
    case "mermaid": return .string("42")
    case "43": return .string("mountain")
    case "mountain": return .string("43")
    case "44": return .string("one_legged_downward_facing_pose_open_hip_bent_knee")
    case "one_legged_downward_facing_pose_open_hip_bent_knee": return .string("44")
    case "45": return .string("one_legged_pigeon")
    case "one_legged_pigeon": return .string("45")
    case "46": return .string("peaceful_warrior")
    case "peaceful_warrior": return .string("46")
    case "47": return .string("plank")
    case "plank": return .string("47")
    case "48": return .string("plow")
    case "plow": return .string("48")
    case "49": return .string("reclined_hand_to_foot")
    case "reclined_hand_to_foot": return .string("49")
    case "50": return .string("revolved_half_moon")
    case "revolved_half_moon": return .string("50")
    case "51": return .string("revolved_head_to_knee")
    case "revolved_head_to_knee": return .string("51")
    case "52": return .string("revolved_triangle")
    case "revolved_triangle": return .string("52")
    case "53": return .string("runners_lunge")
    case "runners_lunge": return .string("53")
    case "54": return .string("seated_easy_side_bend")
    case "seated_easy_side_bend": return .string("54")
    case "55": return .string("seated_easy_twist")
    case "seated_easy_twist": return .string("55")
    case "56": return .string("seated_long_leg_forward_bend")
    case "seated_long_leg_forward_bend": return .string("56")
    case "57": return .string("seated_wide_leg_forward_bend")
    case "seated_wide_leg_forward_bend": return .string("57")
    case "58": return .string("shoulder_stand")
    case "shoulder_stand": return .string("58")
    case "59": return .string("side_boat")
    case "side_boat": return .string("59")
    case "60": return .string("side_plank")
    case "side_plank": return .string("60")
    case "61": return .string("sphinx")
    case "sphinx": return .string("61")
    case "62": return .string("squat_open_arm_twist")
    case "squat_open_arm_twist": return .string("62")
    case "63": return .string("squat_palm_press")
    case "squat_palm_press": return .string("63")
    case "64": return .string("staff")
    case "staff": return .string("64")
    case "65": return .string("standing_arms_up")
    case "standing_arms_up": return .string("65")
    case "66": return .string("standing_forward_bend_halfway_up")
    case "standing_forward_bend_halfway_up": return .string("66")
    case "67": return .string("standing_forward_bend")
    case "standing_forward_bend": return .string("67")
    case "68": return .string("standing_side_opener")
    case "standing_side_opener": return .string("68")
    case "69": return .string("standing_single_leg_forward_bend")
    case "standing_single_leg_forward_bend": return .string("69")
    case "70": return .string("standing_split")
    case "standing_split": return .string("70")
    case "71": return .string("standing_wide_leg_forward_bend")
    case "standing_wide_leg_forward_bend": return .string("71")
    case "72": return .string("standing_wide_leg_forward_bend_with_twist")
    case "standing_wide_leg_forward_bend_with_twist": return .string("72")
    case "73": return .string("supine_spinal_twist")
    case "supine_spinal_twist": return .string("73")
    case "74": return .string("table_top")
    case "table_top": return .string("74")
    case "75": return .string("thread_the_needle")
    case "thread_the_needle": return .string("75")
    case "76": return .string("thunderbolt")
    case "thunderbolt": return .string("76")
    case "77": return .string("thunderbolt_pose_both_sides_arm_stretch")
    case "thunderbolt_pose_both_sides_arm_stretch": return .string("77")
    case "78": return .string("tree")
    case "tree": return .string("78")
    case "79": return .string("triangle")
    case "triangle": return .string("79")
    case "80": return .string("up_dog")
    case "up_dog": return .string("80")
    case "81": return .string("upward_facing_plank")
    case "upward_facing_plank": return .string("81")
    case "82": return .string("warrior_one")
    case "warrior_one": return .string("82")
    case "83": return .string("warrior_three")
    case "warrior_three": return .string("83")
    case "84": return .string("warrior_two")
    case "warrior_two": return .string("84")
    case "85": return .string("wheel")
    case "wheel": return .string("85")
    case "86": return .string("wide_side_lunge")
    case "wide_side_lunge": return .string("86")
    case "87": return .string("deep_breathing_wheelchair")
    case "deep_breathing_wheelchair": return .string("87")
    case "88": return .string("deep_breathing_low_wheelchair")
    case "deep_breathing_low_wheelchair": return .string("88")
    case "89": return .string("deep_breathing_mid_wheelchair")
    case "deep_breathing_mid_wheelchair": return .string("89")
    case "90": return .string("deep_breathing_high_wheelchair")
    case "deep_breathing_high_wheelchair": return .string("90")
    case "91": return .string("prayer_wheelchair")
    case "prayer_wheelchair": return .string("91")
    case "92": return .string("overhead_prayer_wheelchair")
    case "overhead_prayer_wheelchair": return .string("92")
    case "93": return .string("cactus_wheelchair")
    case "cactus_wheelchair": return .string("93")
    case "94": return .string("breathing_punches_wheelchair")
    case "breathing_punches_wheelchair": return .string("94")
    case "95": return .string("breathing_punches_extended_wheelchair")
    case "breathing_punches_extended_wheelchair": return .string("95")
    case "96": return .string("breathing_punches_overhead_wheelchair")
    case "breathing_punches_overhead_wheelchair": return .string("96")
    case "97": return .string("breathing_punches_overhead_and_down_wheelchair")
    case "breathing_punches_overhead_and_down_wheelchair": return .string("97")
    case "98": return .string("breathing_punches_side_wheelchair")
    case "breathing_punches_side_wheelchair": return .string("98")
    case "99": return .string("breathing_punches_extended_side_wheelchair")
    case "breathing_punches_extended_side_wheelchair": return .string("99")
    case "100": return .string("breathing_punches_overhead_side_wheelchair")
    case "breathing_punches_overhead_side_wheelchair": return .string("100")
    case "101": return .string("breathing_punches_overhead_and_down_side_wheelchair")
    case "breathing_punches_overhead_and_down_side_wheelchair": return .string("101")
    case "102": return .string("left_hand_back_wheelchair")
    case "left_hand_back_wheelchair": return .string("102")
    case "103": return .string("triangle_wheelchair")
    case "triangle_wheelchair": return .string("103")
    case "104": return .string("thread_the_needle_wheelchair")
    case "thread_the_needle_wheelchair": return .string("104")
    case "105": return .string("neck_flexion_and_extension_wheelchair")
    case "neck_flexion_and_extension_wheelchair": return .string("105")
    case "106": return .string("neck_lateral_flexion_wheelchair")
    case "neck_lateral_flexion_wheelchair": return .string("106")
    case "107": return .string("spine_flexion_and_extension_wheelchair")
    case "spine_flexion_and_extension_wheelchair": return .string("107")
    case "108": return .string("spine_rotation_wheelchair")
    case "spine_rotation_wheelchair": return .string("108")
    case "109": return .string("spine_lateral_flexion_wheelchair")
    case "spine_lateral_flexion_wheelchair": return .string("109")
    case "110": return .string("alternative_skiing_wheelchair")
    case "alternative_skiing_wheelchair": return .string("110")
    case "111": return .string("reach_forward_wheelchair")
    case "reach_forward_wheelchair": return .string("111")
    case "112": return .string("warrior_wheelchair")
    case "warrior_wheelchair": return .string("112")
    case "113": return .string("reverse_warrior_wheelchair")
    case "reverse_warrior_wheelchair": return .string("113")
    case "114": return .string("downward_facing_dog_to_cobra")
    case "downward_facing_dog_to_cobra": return .string("114")
    case "115": return .string("seated_cat_cow")
    case "seated_cat_cow": return .string("115")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_triceps_extension_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "41": return .string("alternating_dumbbell_lying_triceps_extension")
    case "alternating_dumbbell_lying_triceps_extension": return .string("41")
    case "42": return .string("triceps_press")
    case "triceps_press": return .string("42")
    case "43": return .string("dumbbell_kickback_wheelchair")
    case "dumbbell_kickback_wheelchair": return .string("43")
    case "44": return .string("overhead_dumbbell_triceps_extension_wheelchair")
    case "overhead_dumbbell_triceps_extension_wheelchair": return .string("44")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_warm_up_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "31": return .string("biceps_stretch")
    case "biceps_stretch": return .string("31")
    case "32": return .string("glutes_stretch")
    case "glutes_stretch": return .string("32")
    case "33": return .string("standing_hamstring_stretch")
    case "standing_hamstring_stretch": return .string("33")
    case "34": return .string("stretch_90_90")
    case "stretch_90_90": return .string("34")
    case "35": return .string("stretch_abs")
    case "stretch_abs": return .string("35")
    case "36": return .string("stretch_butterfly")
    case "stretch_butterfly": return .string("36")
    case "37": return .string("stretch_calf")
    case "stretch_calf": return .string("37")
    case "38": return .string("stretch_cat_cow")
    case "stretch_cat_cow": return .string("38")
    case "39": return .string("stretch_childs_pose")
    case "stretch_childs_pose": return .string("39")
    case "40": return .string("stretch_cobra")
    case "stretch_cobra": return .string("40")
    case "41": return .string("stretch_forearms")
    case "stretch_forearms": return .string("41")
    case "42": return .string("stretch_forward_glutes")
    case "stretch_forward_glutes": return .string("42")
    case "43": return .string("stretch_front_split")
    case "stretch_front_split": return .string("43")
    case "44": return .string("stretch_hamstring")
    case "stretch_hamstring": return .string("44")
    case "45": return .string("stretch_hip_flexor_and_quad")
    case "stretch_hip_flexor_and_quad": return .string("45")
    case "46": return .string("stretch_lat")
    case "stretch_lat": return .string("46")
    case "47": return .string("stretch_levator_scapulae")
    case "stretch_levator_scapulae": return .string("47")
    case "48": return .string("stretch_lunge_with_spinal_twist")
    case "stretch_lunge_with_spinal_twist": return .string("48")
    case "49": return .string("stretch_lunging_hip_flexor")
    case "stretch_lunging_hip_flexor": return .string("49")
    case "50": return .string("stretch_lying_abduction")
    case "stretch_lying_abduction": return .string("50")
    case "51": return .string("stretch_lying_it_band")
    case "stretch_lying_it_band": return .string("51")
    case "52": return .string("stretch_lying_knee_to_chest")
    case "stretch_lying_knee_to_chest": return .string("52")
    case "53": return .string("stretch_lying_piriformis")
    case "stretch_lying_piriformis": return .string("53")
    case "54": return .string("stretch_lying_spinal_twist")
    case "stretch_lying_spinal_twist": return .string("54")
    case "55": return .string("stretch_neck")
    case "stretch_neck": return .string("55")
    case "56": return .string("stretch_obliques")
    case "stretch_obliques": return .string("56")
    case "57": return .string("stretch_over_under_shoulder")
    case "stretch_over_under_shoulder": return .string("57")
    case "58": return .string("stretch_pectoral")
    case "stretch_pectoral": return .string("58")
    case "59": return .string("stretch_pigeon_pose")
    case "stretch_pigeon_pose": return .string("59")
    case "60": return .string("stretch_piriformis")
    case "stretch_piriformis": return .string("60")
    case "61": return .string("stretch_quad")
    case "stretch_quad": return .string("61")
    case "62": return .string("stretch_scorpion")
    case "stretch_scorpion": return .string("62")
    case "63": return .string("stretch_shoulder")
    case "stretch_shoulder": return .string("63")
    case "64": return .string("stretch_side")
    case "stretch_side": return .string("64")
    case "65": return .string("stretch_side_lunge")
    case "stretch_side_lunge": return .string("65")
    case "66": return .string("stretch_side_split")
    case "stretch_side_split": return .string("66")
    case "67": return .string("stretch_standing_it_band")
    case "stretch_standing_it_band": return .string("67")
    case "68": return .string("stretch_straddle")
    case "stretch_straddle": return .string("68")
    case "69": return .string("stretch_triceps")
    case "stretch_triceps": return .string("69")
    case "70": return .string("stretch_wall_chest_and_shoulder")
    case "stretch_wall_chest_and_shoulder": return .string("70")
    case "71": return .string("neck_rotations_wheelchair")
    case "neck_rotations_wheelchair": return .string("71")
    case "72": return .string("half_kneeling_arm_rotation")
    case "half_kneeling_arm_rotation": return .string("72")
    case "73": return .string("three_way_ankle_mobilization")
    case "three_way_ankle_mobilization": return .string("73")
    case "74": return .string("ninety_ninety_hip_switch")
    case "ninety_ninety_hip_switch": return .string("74")
    case "75": return .string("active_frog")
    case "active_frog": return .string("75")
    case "76": return .string("shoulder_sweeps")
    case "shoulder_sweeps": return .string("76")
    case "77": return .string("ankle_lunges")
    case "ankle_lunges": return .string("77")
    case "78": return .string("back_roll_foam_roller")
    case "back_roll_foam_roller": return .string("78")
    case "79": return .string("bear_crawl")
    case "bear_crawl": return .string("79")
    case "80": return .string("latissimus_dorsi_foam_roll")
    case "latissimus_dorsi_foam_roll": return .string("80")
    case "81": return .string("reverse_t_hip_opener")
    case "reverse_t_hip_opener": return .string("81")
    case "82": return .string("shoulder_rolls")
    case "shoulder_rolls": return .string("82")
    case "83": return .string("chest_openers")
    case "chest_openers": return .string("83")
    case "84": return .string("triceps_stretch")
    case "triceps_stretch": return .string("84")
    case "85": return .string("upper_back_stretch")
    case "upper_back_stretch": return .string("85")
    case "86": return .string("hip_circles")
    case "hip_circles": return .string("86")
    case "87": return .string("ankle_stretch")
    case "ankle_stretch": return .string("87")
    case "88": return .string("marching_in_place")
    case "marching_in_place": return .string("88")
    case "89": return .string("triceps_stretch_wheelchair")
    case "triceps_stretch_wheelchair": return .string("89")
    case "90": return .string("upper_back_stretch_wheelchair")
    case "upper_back_stretch_wheelchair": return .string("90")
   default: return .unknown
  }
}
...
fileprivate func rzfit_swift_reverse_value_run_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    ...
    case "4": return .string("run_or_walk")
    case "run_or_walk": return .string("4")
    case "5": return .string("speed_walk")
    case "speed_walk": return .string("5")
    case "6": return .string("warm_up")
    case "warm_up": return .string("6")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_bike_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("bike")
    case "bike": return .string("0")
    case "1": return .string("ride")
    case "ride": return .string("1")
    case "2": return .string("sprint")
    case "sprint": return .string("2")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_banded_exercises_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "1": return .string("ab_twist")
    case "ab_twist": return .string("1")
    case "2": return .string("back_extension")
    case "back_extension": return .string("2")
    case "3": return .string("bicycle_crunch")
    case "bicycle_crunch": return .string("3")
    case "4": return .string("calf_raises")
    case "calf_raises": return .string("4")
    case "5": return .string("chest_press")
    case "chest_press": return .string("5")
    case "6": return .string("clam_shells")
    case "clam_shells": return .string("6")
    case "7": return .string("curl")
    case "curl": return .string("7")
    case "8": return .string("deadbug")
    case "deadbug": return .string("8")
    case "9": return .string("deadlift")
    case "deadlift": return .string("9")
    case "10": return .string("donkey_kick")
    case "donkey_kick": return .string("10")
    case "11": return .string("external_rotation")
    case "external_rotation": return .string("11")
    case "12": return .string("external_rotation_at_90_degree_abduction")
    case "external_rotation_at_90_degree_abduction": return .string("12")
    case "13": return .string("face_pull")
    case "face_pull": return .string("13")
    case "14": return .string("fire_hydrant")
    case "fire_hydrant": return .string("14")
    case "15": return .string("fly")
    case "fly": return .string("15")
    case "16": return .string("front_raise")
    case "front_raise": return .string("16")
    case "17": return .string("glute_bridge")
    case "glute_bridge": return .string("17")
    case "18": return .string("hamstring_curls")
    case "hamstring_curls": return .string("18")
    case "19": return .string("high_plank_leg_lifts")
    case "high_plank_leg_lifts": return .string("19")
    case "20": return .string("hip_extension")
    case "hip_extension": return .string("20")
    case "21": return .string("internal_rotation")
    case "internal_rotation": return .string("21")
    case "22": return .string("jumping_jack")
    case "jumping_jack": return .string("22")
    case "23": return .string("kneeling_crunch")
    case "kneeling_crunch": return .string("23")
    case "24": return .string("lateral_band_walks")
    case "lateral_band_walks": return .string("24")
    case "25": return .string("lateral_raise")
    case "lateral_raise": return .string("25")
    case "26": return .string("latpull")
    case "latpull": return .string("26")
    case "27": return .string("leg_abduction")
    case "leg_abduction": return .string("27")
    case "28": return .string("leg_adduction")
    case "leg_adduction": return .string("28")
    case "29": return .string("leg_extension")
    case "leg_extension": return .string("29")
    case "30": return .string("lunge")
    case "lunge": return .string("30")
    case "31": return .string("plank")
    case "plank": return .string("31")
    case "32": return .string("pull_apart")
    case "pull_apart": return .string("32")
    case "33": return .string("push_ups")
    case "push_ups": return .string("33")
    case "34": return .string("reverse_crunch")
    case "reverse_crunch": return .string("34")
    case "35": return .string("row")
    case "row": return .string("35")
    case "36": return .string("shoulder_abduction")
    case "shoulder_abduction": return .string("36")
    case "37": return .string("shoulder_extension")
    case "shoulder_extension": return .string("37")
    case "38": return .string("shoulder_external_rotation")
    case "shoulder_external_rotation": return .string("38")
    case "39": return .string("shoulder_flexion_to_90_degrees")
    case "shoulder_flexion_to_90_degrees": return .string("39")
    case "40": return .string("side_plank_leg_lifts")
    case "side_plank_leg_lifts": return .string("40")
    case "41": return .string("side_raise")
    case "side_raise": return .string("41")
    case "42": return .string("squat")
    case "squat": return .string("42")
    case "43": return .string("squat_to_press")
    case "squat_to_press": return .string("43")
    case "44": return .string("tricep_extension")
    case "tricep_extension": return .string("44")
    case "45": return .string("tricep_kickback")
    case "tricep_kickback": return .string("45")
    case "46": return .string("upright_row")
    case "upright_row": return .string("46")
    case "47": return .string("wall_crawl_with_external_rotation")
    case "wall_crawl_with_external_rotation": return .string("47")
    case "49": return .string("lateral_raise_wheelchair")
    case "lateral_raise_wheelchair": return .string("49")
    case "50": return .string("triceps_extension_wheelchair")
    case "triceps_extension_wheelchair": return .string("50")
    case "51": return .string("chest_fly_incline_wheelchair")
    case "chest_fly_incline_wheelchair": return .string("51")
    case "52": return .string("chest_fly_decline_wheelchair")
    case "chest_fly_decline_wheelchair": return .string("52")
    case "53": return .string("pull_down_wheelchair")
    case "pull_down_wheelchair": return .string("53")
    case "54": return .string("straight_arm_pull_down_wheelchair")
    case "straight_arm_pull_down_wheelchair": return .string("54")
    case "55": return .string("curl_wheelchair")
    case "curl_wheelchair": return .string("55")
    case "56": return .string("overhead_curl_wheelchair")
    case "overhead_curl_wheelchair": return .string("56")
    case "57": return .string("face_pull_wheelchair")
    case "face_pull_wheelchair": return .string("57")
    case "58": return .string("around_the_world_wheelchair")
    case "around_the_world_wheelchair": return .string("58")
    case "59": return .string("pull_apart_wheelchair")
    case "pull_apart_wheelchair": return .string("59")
    case "60": return .string("side_curl_wheelchair")
    case "side_curl_wheelchair": return .string("60")
    case "61": return .string("overhead_press_wheelchair")
    case "overhead_press_wheelchair": return .string("61")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_battle_rope_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("alternating_figure_eight")
    case "alternating_figure_eight": return .string("0")
    case "1": return .string("alternating_jump_wave")
    case "alternating_jump_wave": return .string("1")
    case "2": return .string("alternating_kneeling_to_standing_wave")
    case "alternating_kneeling_to_standing_wave": return .string("2")
    case "3": return .string("alternating_lunge_wave")
    case "alternating_lunge_wave": return .string("3")
    case "4": return .string("alternating_squat_wave")
    case "alternating_squat_wave": return .string("4")
    case "5": return .string("alternating_wave")
    case "alternating_wave": return .string("5")
    case "6": return .string("alternating_wave_with_lateral_shuffle")
    case "alternating_wave_with_lateral_shuffle": return .string("6")
    case "7": return .string("clap_wave")
    case "clap_wave": return .string("7")
    case "8": return .string("double_arm_figure_eight")
    case "double_arm_figure_eight": return .string("8")
    case "9": return .string("double_arm_side_to_side_snake")
    case "double_arm_side_to_side_snake": return .string("9")
    case "10": return .string("double_arm_side_wave")
    case "double_arm_side_wave": return .string("10")
    case "11": return .string("double_arm_slam")
    case "double_arm_slam": return .string("11")
    case "12": return .string("double_arm_wave")
    case "double_arm_wave": return .string("12")
    case "13": return .string("grappler_toss")
    case "grappler_toss": return .string("13")
    case "14": return .string("hip_toss")
    case "hip_toss": return .string("14")
    case "15": return .string("in_and_out_wave")
    case "in_and_out_wave": return .string("15")
    case "16": return .string("inside_circle")
    case "inside_circle": return .string("16")
    case "17": return .string("jumping_jacks")
    case "jumping_jacks": return .string("17")
    case "18": return .string("outside_circle")
    case "outside_circle": return .string("18")
    case "19": return .string("rainbow")
    case "rainbow": return .string("19")
    case "20": return .string("side_plank_wave")
    case "side_plank_wave": return .string("20")
    case "21": return .string("sidewinder")
    case "sidewinder": return .string("21")
    case "22": return .string("sitting_russian_twist")
    case "sitting_russian_twist": return .string("22")
    case "23": return .string("snake_wave")
    case "snake_wave": return .string("23")
    case "24": return .string("split_jack")
    case "split_jack": return .string("24")
    case "25": return .string("stage_coach")
    case "stage_coach": return .string("25")
    case "26": return .string("ultimate_warrior")
    case "ultimate_warrior": return .string("26")
    case "27": return .string("upper_cuts")
    case "upper_cuts": return .string("27")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_elliptical_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("elliptical")
    case "elliptical": return .string("0")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_floor_climb_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("floor_climb")
    case "floor_climb": return .string("0")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_indoor_bike_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("air_bike")
    case "air_bike": return .string("0")
    case "1": return .string("assault_bike")
    case "assault_bike": return .string("1")
    case "3": return .string("stationary_bike")
    case "stationary_bike": return .string("3")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_indoor_row_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("rowing_machine")
    case "rowing_machine": return .string("0")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_ladder_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("agility")
    case "agility": return .string("0")
    case "1": return .string("speed")
    case "speed": return .string("1")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_sandbag_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("around_the_world")
    case "around_the_world": return .string("0")
    case "1": return .string("back_squat")
    case "back_squat": return .string("1")
    case "2": return .string("bear_crawl_pull_through")
    case "bear_crawl_pull_through": return .string("2")
    case "3": return .string("bear_hug_squat")
    case "bear_hug_squat": return .string("3")
    case "4": return .string("clean")
    case "clean": return .string("4")
    case "5": return .string("clean_and_press")
    case "clean_and_press": return .string("5")
    case "6": return .string("curl")
    case "curl": return .string("6")
    case "7": return .string("front_carry")
    case "front_carry": return .string("7")
    case "8": return .string("front_squat")
    case "front_squat": return .string("8")
    case "9": return .string("lunge")
    case "lunge": return .string("9")
    case "10": return .string("overhead_press")
    case "overhead_press": return .string("10")
    case "11": return .string("plank_pull_through")
    case "plank_pull_through": return .string("11")
    case "12": return .string("rotational_lunge")
    case "rotational_lunge": return .string("12")
    case "13": return .string("row")
    case "row": return .string("13")
    case "14": return .string("russian_twist")
    case "russian_twist": return .string("14")
    case "15": return .string("shouldering")
    case "shouldering": return .string("15")
    case "16": return .string("shoveling")
    case "shoveling": return .string("16")
    case "17": return .string("side_lunge")
    case "side_lunge": return .string("17")
    case "18": return .string("sprint")
    case "sprint": return .string("18")
    case "19": return .string("zercher_squat")
    case "zercher_squat": return .string("19")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_sled_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("backward_drag")
    case "backward_drag": return .string("0")
    case "1": return .string("chest_press")
    case "chest_press": return .string("1")
    case "2": return .string("forward_drag")
    case "forward_drag": return .string("2")
    case "3": return .string("low_push")
    case "low_push": return .string("3")
    case "4": return .string("push")
    case "push": return .string("4")
    case "5": return .string("row")
    case "row": return .string("5")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_sledge_hammer_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("lateral_swing")
    case "lateral_swing": return .string("0")
    case "1": return .string("hammer_slam")
    case "hammer_slam": return .string("1")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_stair_stepper_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("stair_stepper")
    case "stair_stepper": return .string("0")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_suspension_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("chest_fly")
    case "chest_fly": return .string("0")
    case "1": return .string("chest_press")
    case "chest_press": return .string("1")
    case "2": return .string("crunch")
    case "crunch": return .string("2")
    case "3": return .string("curl")
    case "curl": return .string("3")
    case "4": return .string("dip")
    case "dip": return .string("4")
    case "5": return .string("face_pull")
    case "face_pull": return .string("5")
    case "6": return .string("glute_bridge")
    case "glute_bridge": return .string("6")
    case "7": return .string("hamstring_curl")
    case "hamstring_curl": return .string("7")
    case "8": return .string("hip_drop")
    case "hip_drop": return .string("8")
    case "9": return .string("inverted_row")
    case "inverted_row": return .string("9")
    case "10": return .string("knee_drive_jump")
    case "knee_drive_jump": return .string("10")
    case "11": return .string("knee_to_chest")
    case "knee_to_chest": return .string("11")
    case "12": return .string("lat_pullover")
    case "lat_pullover": return .string("12")
    case "13": return .string("lunge")
    case "lunge": return .string("13")
    case "14": return .string("mountain_climber")
    case "mountain_climber": return .string("14")
    case "15": return .string("pendulum")
    case "pendulum": return .string("15")
    case "16": return .string("pike")
    case "pike": return .string("16")
    case "17": return .string("plank")
    case "plank": return .string("17")
    case "18": return .string("power_pull")
    case "power_pull": return .string("18")
    case "19": return .string("pull_up")
    case "pull_up": return .string("19")
    case "20": return .string("push_up")
    case "push_up": return .string("20")
    case "21": return .string("reverse_mountain_climber")
    case "reverse_mountain_climber": return .string("21")
    case "22": return .string("reverse_plank")
    case "reverse_plank": return .string("22")
    case "23": return .string("rollout")
    case "rollout": return .string("23")
    case "24": return .string("row")
    case "row": return .string("24")
    case "25": return .string("side_lunge")
    case "side_lunge": return .string("25")
    case "26": return .string("side_plank")
    case "side_plank": return .string("26")
    case "27": return .string("single_leg_deadlift")
    case "single_leg_deadlift": return .string("27")
    case "28": return .string("single_leg_squat")
    case "single_leg_squat": return .string("28")
    case "29": return .string("sit_up")
    case "sit_up": return .string("29")
    case "30": return .string("split")
    case "split": return .string("30")
    case "31": return .string("squat")
    case "squat": return .string("31")
    case "32": return .string("squat_jump")
    case "squat_jump": return .string("32")
    case "33": return .string("tricep_press")
    case "tricep_press": return .string("33")
    case "34": return .string("y_fly")
    case "y_fly": return .string("34")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_tire_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("flip")
    case "flip": return .string("0")
   default: return .unknown
  }
}

fileprivate func rzfit_swift_reverse_value_bike_outdoor_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("bike")
    case "bike": return .string("0")
...
fileprivate func rzfit_swift_reverse_value_run_indoor_exercise_name(value : String) -> RzFitSwiftValue
{
   switch value {
    case "0": return .string("indoor_track_run")
    case "indoor_track_run": return .string("0")
    case "1": return .string("treadmill")
    case "treadmill": return .string("1")
   default: return .unknown
  }
